...
async def cmd_gm(message: Message, command: CommandObject, users: UserRepository) -> None:
    caller = (await users.get_or_create(message.from_user.id, message.from_user.username))[0]
